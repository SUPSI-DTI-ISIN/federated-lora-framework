...
export const useUpdateDocumentTrainability = () => {
    ...
    return useMutation<DocumentDTO, Error, UpdateDocumentTrainabilityParams>({
        mutationFn: async ({documentId, isTrainable}: UpdateDocumentTrainabilityParams) => documentsApi.updateDocumentTrainableApiDataDocumentsTrainabilityDocumentIdPut(
            documentId,
            {
