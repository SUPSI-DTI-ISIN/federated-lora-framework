...
class TestGetSessionFactory:
    def test_raises_when_not_initialized(self):
        with pytest.raises(RuntimeError, match="does not initialize"):
            DatabaseConnector.get_session_factory()

    def test_returns_session_factory_when_initialized(self):
        mock_session_maker = MagicMock()
        DatabaseConnector._async_session_local = mock_session_maker

        assert DatabaseConnector.get_session_factory() is mock_session_maker
