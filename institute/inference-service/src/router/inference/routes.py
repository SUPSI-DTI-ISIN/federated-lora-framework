...
async def query(query_request_dto: QueryRequestDTO, model_service: ModelServiceInterface = Depends(get_model_service), inference_service: InferenceServiceInterface = Depends(get_inference_service)):
