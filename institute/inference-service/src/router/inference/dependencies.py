...
def get_model_service(max_cached_adapters: int = settings.max_cached_adapters, device_map: str = settings.device_map, model_service_client: ModelServiceClientInterface = Depends(get_model_service_client)) -> ModelServiceInterface:
